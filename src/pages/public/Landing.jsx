...
const features = [
  ...
  },
  {
    ...
    text: "Blind screening removes PII from the review flow so recruiters focus on signal.",
  },
  {
...
const steps = [
  ...
  "Rank semantically with blind screening",
        ...
        <section className="grid gap-8 py-8 lg:grid-cols-[1.1fr_0.9fr] lg:py-14">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">
              AI-powered resume screening built for faster, fairer hiring.
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
              Screen resumes contextually, protect against bias with blind review,
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {["Blind screening", "Semantic match scores", "Digital 201 files", "Recruiter analytics"].map(
                (item) => (
                  <span
                    key={item}
          ...
          <div className="surface-card p-6 sm:p-8">
            <div className="rounded-[2rem] bg-slate-950 p-6 text-white shadow-soft">
              ...
              <h2 className="mt-3 text-2xl font-semibold">
                One system, three core workflows
              </h2>
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {[
                  ["Resume intake", "AI parsing and upload feedback"],
                  ["Screening", "Blind candidate ranking"],
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl bg-slate-50 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  Keep PII out of the review loop while ranking semantic fit.
                </p>
              </div>
              <div className="rounded-3xl bg-slate-50 p-5">
                <p className="text-sm font-semibold text-slate-900">
