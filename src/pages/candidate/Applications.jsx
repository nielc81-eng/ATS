...
const statusPillByValue = {
  [APPLICATION_STATUS.Submitted]: "bg-slate-100 text-slate-700",
  [APPLICATION_STATUS.Shortlisted]: "bg-sky-100 text-sky-700",
  [APPLICATION_STATUS.Interview]: "bg-indigo-100 text-indigo-700",
  [APPLICATION_STATUS.InterviewInitial]: "bg-sky-100 text-sky-700",
  [APPLICATION_STATUS.InterviewFinal]: "bg-indigo-100 text-indigo-700",
  [APPLICATION_STATUS.Offer]: "bg-violet-100 text-violet-700",
  [APPLICATION_STATUS.PostHireDocsSubmitted]: "bg-violet-100 text-violet-700",
  [APPLICATION_STATUS.Hired]: "bg-emerald-100 text-emerald-700",
  [APPLICATION_STATUS.HiredOnboarding]: "bg-emerald-100 text-emerald-700",
  [APPLICATION_STATUS.PooledForFutureOpportunities]: "bg-amber-100 text-amber-700",
  [APPLICATION_STATUS.BackoutArchived]: "bg-rose-100 text-rose-700",
          ...
          <div className="divide-y divide-slate-100">
            {applications.map((application) => (
              <article key={application.id} className="px-6 py-5">
                ...
                {application.status === APPLICATION_STATUS.PooledForFutureOpportunities ? (
                  <p className="mt-3 rounded-2xl border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-800">
                    Branch outcome: Pooled for Future Opportunities.
                  </p>
                ) : null}
              </article>
            ))}
