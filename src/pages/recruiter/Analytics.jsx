...
function getApplicationMetrics(applications) {
  const counts = applications.reduce(
    (acc, application) => {
      ...
      if (PIPELINE_SHORTLIST_STATUSES.has(application.status)) {
        acc.shortlisted += 1;
      }
      return acc;
    },
    ...
    <PageFrame size="wide">
      ...
      <section className="surface-card p-6 sm:p-8">
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl">
          Recruitment Analytics and Audit Reports
        </h1>
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <select
              ...
              onChange={(event) => {
                if (routeJobId) {
                  navigate(`/recruiter/jobs/${encodeURIComponent(event.target.value)}/analytics`, {
                    replace: true,
                  });
                  return;
                }
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              Generate Recruitment Audit Report (PDF)
            </button>
            <button
              type="button"
            ...
            >
              Generate Recruitment Audit Report (XLSX)
            </button>
          </div>
        </div>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard
          ...
          detail="Semantic ranking output after AI-fit review."
          tone="blue"
        />
        <MetricCard
          label="Time to Fill"
